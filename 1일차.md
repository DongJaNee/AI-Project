...
### 4. 코드 실행
1. 소스코드 파일을 .py(파이선 파일로 저장)
2. cmd 에서 저장한 py 파일 경로로 이동
3. streamlim run <파일이름> 실행 

<img width="758" height="188" alt="image" src="https://github.com/user-attachments/assets/fabb2745-2fbb-4317-bf70-33b045716fd9" />

### 5. 결과


<img width="608" height="354" alt="image" src="https://github.com/user-attachments/assets/41aa5512-c7d5-4458-a8a1-771da1584513" />
